...
/**
 * This represents a generic immutable path between two immutable nodes, particularly
 * Path#getStart() and Path#getEnd(). Behavior of Path is unspecified when node type
 * is mutable. Also contains a cached version of the total cost along this path, for
